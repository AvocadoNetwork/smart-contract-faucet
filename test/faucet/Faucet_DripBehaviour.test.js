...
contract('Faucet Contract - drip behaviour', accounts => {
    ...
    it('Faucet drip behaves correctly in different scenarios', async () => {
        ...
        confirm = await faucet.drip1000AVO({from: accounts[0]})
        faucet_balance = await AVO.balanceOf.call(faucet.address, { from: accounts[0] })
        ...
        eventEmitted = utils.getParamFromTxEvent(confirm, 'receiver', null, 'OneKAVOSent')
        ...
        await assertRevert(faucet.drip5000AVO({from: accounts[0]}))
        ...
        unlockTime = latestTime() + duration.hours(1)
        await increaseTimeTo(unlockTime)
        //sender cannot access drip1000AVO even though 1 hour has passed,
        ...
        confirm = await faucet.drip1000AVO({from: accounts[2]})
        faucet_balance = await AVO.balanceOf.call(faucet.address, { from: accounts[0] })
        ...
        await assertRevert(faucet.drip2000AVO({from: accounts[2]}))
        await assertRevert(faucet.drip5000AVO({from: accounts[2]}))
        ...
        confirm = await faucet.drip5000AVO({from: accounts[3]})
        faucet_balance = await AVO.balanceOf.call(faucet.address, { from: accounts[0] })
        ...
        await assertRevert(faucet.drip1000AVO({from: accounts[3]}))
        await assertRevert(faucet.drip2000AVO({from: accounts[3]}))
        ...
        confirm = await faucet.drip1000AVO({from: accounts[3]})
        faucet_balance = await AVO.balanceOf.call(faucet.address, { from: accounts[0] })
