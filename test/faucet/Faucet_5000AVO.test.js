...
contract('Faucet Contract - drips 5000 AVO', accounts => {
    ...
    it('Faucet correctly sends 5000 AVO', async () => {
        ...
        confirm = await faucet.drip5000AVO({from: accounts[0]})
        faucet_balance = await AVO.balanceOf.call(faucet.address, { from: accounts[0] })
        ...
        eventEmitted = utils.getParamFromTxEvent(confirm, 'receiver', null, 'FiveKAVOSent')
        ...
        confirm = await faucet.drip5000AVO({from: accounts[2]})
        faucet_balance = await AVO.balanceOf.call(faucet.address, { from: accounts[0] })
